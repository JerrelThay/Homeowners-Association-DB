<%-- 
    Document   : m_skilldescList
    Created on : 11 21, 23, 9:35:09 PM
    Author     : ccslearner
--%>
...
<html>
<head>
    <title>List of Maintenance Personnel Grouped by Skills</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h2>Maintenance Personnel Grouped by Skills</h2>
    <%
        ...
        try {
            ...
            String sql = "SELECT personnelid, personnellastname, personnelfirstname, phoneno, skilldesc, hourlyrate, employmentdate, resignationdate FROM maintenancepersonnel ORDER BY skilldesc";
