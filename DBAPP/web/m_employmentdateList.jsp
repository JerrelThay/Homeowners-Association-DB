<%-- 
    Document   : m_employmentdatelist
    Created on : 11 21, 23, 9:23:32 PM
    Author     : ccslearner
--%>
...
<html>
<head>
    <title>List of Maintenance Personnel Grouped by Employment Date</title>
    <style>
        table {
            width: 100%;
...
<body>
        <h2>Maintenance Personnel Grouped by Employment Date </h2>
    <%
        ...
        try {
            ...
            String sql = "SELECT personnelid, personnellastname, personnelfirstname, phoneno, skilldesc, hourlyrate, employmentdate, resignationdate FROM maintenancepersonnel ORDER BY employmentdate";
