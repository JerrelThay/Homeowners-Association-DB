<%-- 
    Document   : m_lastnameList
    Created on : 11 21, 23, 9:26:39 PM
    Author     : ccslearner
--%>
...
<body>
    <h2>Maintenance Personnel Grouped by Last Name</h2>
    <%
        ...
        try {
            ...
            String sql = "SELECT personnelid, personnellastname, personnelfirstname, phoneno, skilldesc, hourlyrate, employmentdate, resignationdate FROM maintenancepersonnel ORDER BY personnellastname";
