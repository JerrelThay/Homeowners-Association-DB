<%-- 
    Document   : m_resignationdateList
    Created on : 11 21, 23, 9:34:18 PM
    Author     : ccslearner
--%>
...
<html>
<head>
    <title>List of Maintenance Personnel Grouped by Resignation Date</title>
    <style>
        table {
            width: 100%;
...
<body>
        <h2>Maintenance Personnel Grouped by Resignation Date </h2>
    <%
        ...
        try {
            ...
            String sql = "SELECT personnelid, personnellastname, personnelfirstname, phoneno, skilldesc, hourlyrate, employmentdate, resignationdate FROM maintenancepersonnel ORDER BY resignationdate";
