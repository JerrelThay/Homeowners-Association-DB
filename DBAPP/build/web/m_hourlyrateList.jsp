<%-- 
    Document   : m_hourlyrateList
    Created on : 11 21, 23, 9:25:48 PM
    Author     : ccslearner
--%>
...
<html>
<head>
    <title>List of Maintenance Personnel Grouped by Hourly Rate</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h2>Maintenance Personnel Grouped by Hourly Rate</h2>
    <%
        ...
        try {
            ...
            String sql = "SELECT personnelid, personnellastname, personnelfirstname, phoneno, skilldesc, hourlyrate, employmentdate, resignationdate FROM maintenancepersonnel ORDER BY hourlyrate";
